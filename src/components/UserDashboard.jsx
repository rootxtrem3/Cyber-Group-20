...
const UserDashboard = ({ user, onLogout }) => {
  ...
  const mockGeoData = [
    { country: 'China', attacks: 12, percentage: 40 },
    { country: 'Russia', attacks: 8, percentage: 27 },
    { country: 'USA', attacks: 5, percentage: 17 },
    { country: 'India', attacks: 3, percentage: 10 },
    { country: 'Others', attacks: 2, percentage: 6 },
  ]
  ...
  const mockRecentAttacks = [
    ...
    { id: 4, ip: '203.0.113.15', country: 'IN', time: '12 min ago', service: 'SSH', status: 'blocked' },
  ]
        ...
        <div className="flex h-16 items-center justify-between px-6">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold">IoT Honeypot User Dashboard</h1>
            </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="geography">Geo Map</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="ai-insights" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-6">
                <p className="text-sm text-muted-foreground">Demo insights using mock data</p>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 rounded-lg border bg-blue-50">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className="font-medium text-blue-700">IMMEDIATE</span>
                      </div>
                    ...
                    <div className="p-3 rounded-lg border bg-green-50">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className="font-medium text-green-700">CONFIGURATION</span>
                      </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Attack Sources Map</span>
                </CardTitle>
                <CardDescription>See where attacks targeting your honeypot come from</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
